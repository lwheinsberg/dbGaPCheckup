...
You can install the development version of dbGaPCheckup from [GitHub](https://github.com/) with:
...
More detailed instructions can be found in the `dbGaPCheckup_vignette` (expanded instructions) or `dbGaPCheckup` (Quick Start) vignette documents, but an introductory example can be found below.
...
This package was developed with partial support from the National Institutes of Health under award numbers R01HL093093, R01HL133040, and K99HD107030.
